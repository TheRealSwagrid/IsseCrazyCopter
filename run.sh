...
cd $ROOT
cd crazyswarm/ros_ws && catkin_make -DCMAKE_BUILD_TYPE=RelWithDebInfo
cd $ROOT
...
source source /ros_ws/devel/setup.bash && roslaunch isse_crazy crazyfly.launch semantix_port:="$port"